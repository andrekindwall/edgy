package com.anroki.edgy.camera;
 ...
 */
public class RotationCamera implements AnalogListener, ActionListener {
     ...
     * @param cam
     */
    public RotationCamera(Camera cam){
        this.cam = cam;
	...
	protected void rotateCamera(float value, Vector3f axis) {
		...
		if (camUpsideDown) {
			cam.setRotation(origRotation); // reset rotation back
		}
	}
